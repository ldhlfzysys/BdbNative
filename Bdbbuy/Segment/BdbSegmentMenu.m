...
@interface BdbSegmentMenu ()<UIScrollViewDelegate,HeaderToolBarDelegate>
...
- (void)HeaderToolScrollBar:(HeaderToolScrollBar *)headerToolBar didSelectItemWithTitle:(NSString *)title withIndex:(NSInteger)index{
    ...
    if([self.delegate respondsToSelector:@selector(BdbSegmentMenuCurrentView:didSelectItemWithIndex:)]){
        [self.delegate BdbSegmentMenuCurrentView:self.viewArr[index] didSelectItemWithIndex:index];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if([self.delegate respondsToSelector:@selector(BdbSegmentMenuCurrentView:didSelectItemWithIndex:)]){
        [self.delegate BdbSegmentMenuCurrentView:self.viewArr[page] didSelectItemWithIndex:page];
    }
}
