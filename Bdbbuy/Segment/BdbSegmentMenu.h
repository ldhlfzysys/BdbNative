...
#define HeaderToolBar_MaxShowTitleNum       10


#import <UIKit/UIKit.h>

@protocol BdbSegmentMenuDelegate <NSObject>
/**
 *  代理方法
 *
 ...
 */
- (void)BdbSegmentMenuCurrentView:(UIView *)currentView didSelectItemWithIndex:(NSInteger)index;

@end

@interface BdbSegmentMenu : UIView
...
@property (nonatomic ,weak) id <BdbSegmentMenuDelegate> delegate;
