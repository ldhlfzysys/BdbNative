...
@implementation BdbHomeHeadData
...
+ (void)loadHeadData:(CompleteBlock)complete {
    ...
    BdbHomeHeadData *homeHeadData = [BdbHomeHeadData mj_objectWithKeyValues:json[@"data"]];
...
+(NSDictionary *)mj_objectClassInArray {
    return @{@"goods":NSStringFromClass([BdbGoods class])};
}
