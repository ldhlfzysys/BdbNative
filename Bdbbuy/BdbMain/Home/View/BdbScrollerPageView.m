...
@interface BdbScrollerPageView ()<UIScrollViewDelegate>
...
@implementation BdbScrollerPageView

+ (instancetype)pageScroller:(NSArray <NSString *>*)images placeHolderImage:(UIImage *)placeHolderImage{
    BdbScrollerPageView *pageView = [[self alloc]init];
    NSArray *bdbimgs = @[@"banner1",@"banner2",@"banner3",@"banner4"];
    pageView.images = bdbimgs;
