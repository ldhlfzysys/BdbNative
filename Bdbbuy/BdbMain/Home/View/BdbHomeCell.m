...
/** 折扣 */
@property (nonatomic,strong) BdbDiscountPriceView *discountPriceView;
/** 选择数量 */
@property (nonatomic,strong) BdbBuyView *buyView;

@property (nonatomic,assign) BdbHomeCellType type;
@end

@implementation BdbHomeCell
...
- (instancetype)initWithFrame:(CGRect)frame{
    if ([super initWithFrame:frame]) {
        ...
        _discountPriceView = [[BdbDiscountPriceView alloc]init];
