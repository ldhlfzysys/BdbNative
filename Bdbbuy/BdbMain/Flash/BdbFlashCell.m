...
+ (instancetype)cellWithTable:(UITableView *)tableView{
    BdbFlashCell *cell = [tableView dequeueReusableCellWithIdentifier:flashCell];
    if (!cell) {
        cell = [[BdbFlashCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:flashCell];
    }
    return cell;
}
